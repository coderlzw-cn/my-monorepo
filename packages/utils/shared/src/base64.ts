...
export function decodeUnpaddedBase64Url(input: string, options: DecodeUnpaddedBase64UrlOptions = {}) {
  return decodeBase64Url(input, { ...options, allowPadding: false, requirePadding: false });
}
...
export function decodeUnpaddedBase64UrlText(input: string, options: DecodeUnpaddedBase64UrlTextOptions = {}) {
  return decodeBase64UrlText(input, { ...options, allowPadding: false, requirePadding: false });
}
...
export function isValidUnpaddedBase64Url(input: string, options: DecodeUnpaddedBase64UrlOptions = {}) {
  return isValidBase64Url(input, { ...options, allowPadding: false, requirePadding: false });
}
...
export function normalizeBase64(input: string, options: NormalizeBase64Options = {}) {
  ...
  return encodeBase64(bytes, { alphabet: resolvedOutputAlphabet, ...(padding === undefined ? {} : { padding }) });
}
...
function assertDecodeOptions(
  ...
  for (const [name, value] of Object.entries({ allowWhitespace, allowEmpty, allowPadding, requirePadding })) {
