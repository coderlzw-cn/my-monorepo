...
export class PageOrderQueryDto extends PageQueryDto {
  @ApiPropertyOptional({
    description: "多字段排序字符串，格式：`field1:asc,field2:desc` 或纯字段 `createdAt`",
  ...
  getOrderClause<T extends string>(allowedFields?: T[], defaultField?: T): Array<Record<string, "asc" | "desc">> {
